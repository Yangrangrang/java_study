...
public class PrimitiveFunction {
    ...
    public static void main(String[] args) {
        // 기본형 매개변수, IntFunction, LongFunction, DoubleFunctio
        IntFunction<String> function = x -> "숫자: " + x;
        System.out.println("function.apply(1) = " + function.apply(1));
        
        // 기본형 매개변수, ToIntFunction, ToLongFunction, ToDoubleFunction
